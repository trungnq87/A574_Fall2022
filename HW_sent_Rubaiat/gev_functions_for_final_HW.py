...
# 3. A function for the GEV quantile function
...
# 4. A function for non-stationary GEV CDF
...
# 5. A function for non-stationary GEV PDF
...
# 6. A function for non-stationary GEV quantile function (QF) 
...
# 9. A 3-D plotting of "non-stationary" PDFs
...
# 10. A plotting for "deeply" looking one case of PDF
...
# 11. A 3-D plotting of "non-stationary" CDFs
...
# 12. A function that generates NS-GEV samples 
...
def gev_ns_samples(t, cmu, mu0, sigma, xi) :
    ...
    out = gev_ns_qf(q, t, cmu, mu0, sigma, xi)

    return out, q

# 12A. A function to calculate the negative of the log-likelihood
...
def gev_ns_log_likelihood(params, x, t) :
    ...
    for i in np.arange(len(t)) :
        ...
        p = gev_ns_pdf(x[i], t[i], params[0], params[1], params[2], params[3])
...
# 14. A function to estimate the ML set of parameters:

def gev_ns_mle(x, t, params0, bounds):
